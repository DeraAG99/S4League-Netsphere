...
namespace BlubLib.Serialization
{
    internal class SerializerGenerator
    {
        ...
        public ISerializer Generate()
        {
            ...
            _typeBuilder = Serializer.ModuleBuilder.DefineType($"{_descriptor.Type.FullName}Serializer", TypeAttributes.Public | TypeAttributes.Class);
            ...
            //foreach (var pair in _customSerializers)
                //CustomSerializers.Add(pair.Key, pair.Value);
        ...
        private void GenerateSerialize(TypeBuilder typeBuilder)
        {
            ...
            using (var obj = emiter.DeclareLocal(_descriptor.Type, "obj"))
            {
                ...
                //    emiter.UnboxAny(_descriptor.Type);
                //else
                //    emiter.CastClass(_descriptor.Type);
