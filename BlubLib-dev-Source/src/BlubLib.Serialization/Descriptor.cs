...
namespace BlubLib.Serialization
{
    ...
    internal static class TypeModel
    {
        ...
        private static Descriptor CreateDescriptor(Type type)
        {
            ...
            var attribute = type.GetCustomAttribute<BlubContractAttribute>();
            if (attribute == null)
                return null;
            ...
            {
                var propAttrib = property.GetCustomAttribute<BlubMemberAttribute>();
                if (propAttrib == null)
                    continue;
        ...
        private static PropertyDescriptor CreateDescriptorFromProperty(PropertyInfo property)
        {
            ...
            var attribute = property.GetCustomAttribute<BlubMemberAttribute>();
            if (attribute.SerializerType != null)
            {
                if (typeof(ISerializer).IsAssignableFrom(attribute.SerializerType))
                {
