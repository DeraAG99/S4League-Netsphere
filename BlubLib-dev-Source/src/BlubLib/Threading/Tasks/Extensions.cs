...
namespace System.Threading.Tasks
{
    ...
    public static class TaskExtensions
    {
        ...
        {
            return @this.ContinueWith(ContinueWithCallback<TState, TResult>, Tuple.Create(continuationAction, state), cancellationToken);
        }
        ...
        {
            return @this.ContinueWith(ContinueWithCallback<TState, TResult>, Tuple.Create(continuationAction, state), continuationOptions);
        }
        ...
        {
            return @this.ContinueWith(ContinueWithCallback<TState, TResult>, Tuple.Create(continuationAction, state), cancellationToken, continuationOptions, scheduler);
        }
    ...
    {
        public static CancellationTokenRegistration Register<TState>(this CancellationToken @this, Action<TState> callback, TState state)
        {
            return @this.Register(RegisterCallback<TState>, Tuple.Create(callback, state));
        }

        public static CancellationTokenRegistration Register<TState>(this CancellationToken @this, Action<TState> callback, TState state, bool useSynchronizationContext)
        {
