...
namespace NeoNetsphere.Network.Message.Game
{
  ...
  public class LoginReguestAckMessage : IGameMessage
  {
    ...
    [BlubMember(1)] public GameLoginResult Result { get; set; }
  ...
  public class PlayerAccountInfoAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public PlayerAccountInfoDto Info { get; set; }
  }
  ...
  public class CharacterCurrentInfoAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public byte Slot { get; set; }

    [BlubMember(1)] public byte Unk1 { get; set; }

    [BlubMember(2)] public byte Unk2 { get; set; }

    [BlubMember(3)] public CharacterStyle Style { get; set; }
  }
  ...
  public class CSuccessCreateCharacterAckMessage : IGameMessage
  {
    ...
    [BlubMember(1)] public CharacterStyle Style { get; set; }

    [BlubMember(2)] public byte MaxSkills { get; set; }

    [BlubMember(3)] public byte MaxWeapons { get; set; }
  }
  ...
  public class ServerResultAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public ServerResult Result { get; set; }
  }
  ...
  public class ItemUseItemAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public byte CharacterSlot { get; set; }

    [BlubMember(1)] public byte EquipSlot { get; set; }

    [BlubMember(2)] public ulong ItemId { get; set; }

    [BlubMember(3)] public UseItemAction Action { get; set; }
  }
  ...
  public class ItemUpdateInventoryAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public InventoryAction Action { get; set; }

    [BlubMember(1)] public ItemDto Item { get; set; }
  }
  ...
  public class RoomCurrentCharacterSlotAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public uint Unk { get; set; }

    [BlubMember(1)] public byte Slot { get; set; }
  }
  ...
  public class RoomEnterPlayerInfoAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public RoomPlayerDto Player { get; set; }
  }
  ...
  public class RoomEnterClubInfoAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public PlayerClubInfoDto Club { get; set; }
  }
  ...
  public class RoomPlayerInfoListForEnterPlayerForCollectBookAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public int Count { get; set; }
  }
  ...
  public class RoomEnterRoomInfoAck2Message : IGameMessage
  {
    ...
    [BlubMember(0)] public uint RoomId { get; set; }

    [BlubMember(1)] public NeoNetsphere.GameRule GameRule { get; set; }

    [BlubMember(2)] public byte MapId { get; set; }

    [BlubMember(3)] public byte PlayerLimit { get; set; }

    [BlubMember(4)] public GameState GameState { get; set; }

    [BlubMember(5)] public GameTimeState GameTimeState { get; set; }

    [BlubMember(6)] public uint TimeLimit { get; set; }

    [BlubMember(7)] public uint Unk1 { get; set; }

    [BlubMember(8)] public uint TimeSync { get; set; }

    [BlubMember(9)] public uint ScoreLimit { get; set; }

    [BlubMember(10)] public byte Unk2 { get; set; }

    [BlubMember(11, typeof(IPEndPointAddressStringSerializer))]
    public IPEndPoint RelayEndPoint { get; set; }

    [BlubMember(12)] public int Unk3 { get; set; }

    [BlubMember(13)] public byte Unk4 { get; set; }

    [BlubMember(14)] public int Unk5 { get; set; }

    [BlubMember(15)] public int Unk6 { get; set; }

    [BlubMember(16)] public byte LastMapId { get; set; }
  }
  ...
  {
    [BlubMember(0)] public uint ClientTime { get; set; }

    [BlubMember(1)] public uint ServerTime { get; set; }
  }
  ...
  public class RoomChangeRoomInfoAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public RoomDto Room { get; set; }
  }
  ...
  public class GamePlayerInfoAckMessage : IGameMessage
  {
    ...
    [BlubMember(2)] public int Unk1 { get; set; }

    [BlubMember(3)] public int Unk2 { get; set; }

    [BlubMember(4)] public byte Unk3 { get; set; }

    [BlubMember(5)] public int Unk4 { get; set; }

    [BlubMember(6)] public int Unk5 { get; set; }

    [BlubMember(7)] public int Unk6 { get; set; }

    [BlubMember(8)] public int Unk7 { get; set; }

    [BlubMember(9)] public int Unk8 { get; set; }

    [BlubMember(10)] public int Unk9 { get; set; }
  }
  ...
  public class ItemBuyItemAckMessage : IGameMessage
  {
    ...
    [BlubMember(1)] public ItemBuyResult Result { get; set; }

    [BlubMember(2)] public ShopItemDto Item { get; set; }
  }

  [BlubContract]
  public class ItemRepairItemAckMessage : IGameMessage
  {
    [BlubMember(0)] public ItemRepairResult Result { get; set; }

    [BlubMember(1)] public ulong ItemId { get; set; }
  }
  ...
  {
    [BlubMember(0)] public ulong ItemId { get; set; }

    [BlubMember(1)] public ItemRefundResult Result { get; set; }
  }
  ...
  public class MoneyRefreshCashInfoAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public uint PEN { get; set; }

    [BlubMember(1)] public uint AP { get; set; }
  }
  ...
  public class AdminActionAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public byte Result { get; set; }
  ...
  public class AdminShowWindowAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public bool DisableConsole { get; set; }
  }
  ...
  {
    [BlubMember(0)] public byte CharacterCount { get; set; }

    [BlubMember(1)] public byte MaxSlots { get; set; }

    [BlubMember(2)] public byte ActiveCharacter { get; set; }
  }
  ...
  public class ClubInfoAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public PlayerClubInfoDto ClubInfo { get; set; }
  }
  ...
  public class ClubHistoryAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public ClubHistoryDto History { get; set; }
  }
  ...
  {
    [BlubMember(0)] public uint TaskId { get; set; }

    [BlubMember(1)] public ushort Progress { get; set; }
  }
  ...
  public class TaskRequestAckMessage : IGameMessage
  {
    ...
    [BlubMember(1)] public MissionRewardType RewardType { get; set; }

    [BlubMember(2)] public uint Reward { get; set; }

    [BlubMember(3)] public byte Slot { get; set; }
  }
  ...
  {
    [BlubMember(0)] public uint ArcadeCoins { get; set; }

    [BlubMember(1)] public uint BuffCoins { get; set; }
  ...
  public class ItemUseEsperChipItemAckMessage : IGameMessage
  {
    ...
    [BlubMember(1)] public long Unk2 { get; set; }
  ...
  {
    [BlubMember(0)] public ArcadeRewardDto Reward { get; set; }
  }
  ...
  public class ItemUseCapsuleAckMessage : IGameMessage
  {
    ...
    [BlubMember(1)] public byte Result { get; set; }
  }
  ...
  [BlubContract]
  public class GameClubJoinAckMessage : IGameMessage
  {
  ...
  public class ClubUnJoinAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public uint Result { get; set; }
  }
  ...
  public class NewShopUpdataInfoAckMessage : IGameMessage
  {
    ...
    [BlubMember(2)]
    public int DataLength { get; set; } // size of Data?
  ...
  public class ItemUseChangeNickAckMessage : IGameMessage
  {
    ...
    [BlubMember(1)] public ulong Unk2 { get; set; }
  ...
  public class PlayerFindInfoAckMessage : IGameMessage
  {
    ...
    [BlubMember(2)] public int Unk2 { get; set; }

    [BlubMember(3, typeof(StringSerializer))]
    public string Unk3 { get; set; }

    [BlubMember(4)] public int Unk4 { get; set; }

    [BlubMember(5)] public int Unk5 { get; set; }

    [BlubMember(6)] public int Unk6 { get; set; }
  }
  ...
  public class ClubAddressAckMessage : IGameMessage
  {
    ...
    [BlubMember(1)] public uint Unk2 { get; set; }
  }
  ...
  public class RequitalEventItemRewardAckMessage : IGameMessage
  {
    ...
    [BlubMember(3)] public uint Unk4 { get; set; }

    [BlubMember(4)] public uint Unk5 { get; set; }

    [BlubMember(5)] public uint Unk6 { get; set; }

    [BlubMember(6)] public uint Unk7 { get; set; }
  }
  ...
  public class ShoppingBasketActionAckMessage : IGameMessage
  {
    ...
    [BlubMember(2)] public ShoppingBasketDto Item { get; set; }
  }
  ...
  {
    [BlubMember(0)] public RoomInfoRequestDto Info { get; set; }
  }
  ...
  public class CardGambleAckMessage : IGameMessage
  {
    ...
    [BlubMember(1)] public ShopItemDto ShopItem { get; set; }
  }
  ...
  public class NoticeItemGainAckMessage : IGameMessage
  {
    ...
    [BlubMember(2)] public ulong AccountId { get; set; }

    [BlubMember(3)] public int Unk4 { get; set; }

    [BlubMember(4)] public int Unk5 { get; set; }

    [BlubMember(5)] public short Unk6 { get; set; }

    [BlubMember(6)] public int Unk7 { get; set; }
  }
  ...
  public class PromotionCardShuffleAckMessage : IGameMessage
  {
    ...
    [BlubMember(1)] public RequitalLevelDto Unk2 { get; set; }
  }
  ...
  public class ExpRefreshInfoAckMessage : IGameMessage
  {
    ...
    [BlubMember(0)] public uint TotalExp { get; set; }
  }
  ...
  public class ClubNoticePointRefreshAckMessage : IGameMessage
  {
    ...
    [BlubMember(7)] public uint Unk8 { get; set; }

    [BlubMember(8)] public uint Unk9 { get; set; }
  }
  ...
  [BlubContract]
  public class PlayerKickMessageAckMessage : IGameMessage
  {
    [BlubMember(0)]
  ...
  public class EspherChipLv5Message : IGameMessage
  {
    [BlubMember(0)]
    public int Type { get; set; }
  ...
  [BlubContract]
  public class BattleyeS2CDataMessage : IGameMessage
  {
    ...
    // 1 - initack
    // 2 - initreq
    // 3 - some info c2s&s2c (heartbeat, ...)
    // 35 - some ack

    // client info messages (client sends them besides heartbeat-response each x mins)
    // 25 - some big info (c2s)
    // 170 - some big info (c2s)

    [BlubMember(1, typeof(ArrayWithScalarSerializer))]
    public byte[] Data { get; set; }

    //heartbeat     : size: 3 data: 09 count (s2c&c2s)
    //beservice dead: size: 1 data: 0B (c2s)
  }
}
