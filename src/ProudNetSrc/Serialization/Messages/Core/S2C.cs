...
namespace ProudNetSrc.Serialization.Messages.Core
{
  ...
  {
    [BlubMember(0)] public ushort Unk { get; set; }
  }
  ...
  internal class NotifyServerConnectSuccessMessage : ICoreMessage
  {
    ...
    [BlubMember(0)] public uint HostId { get; set; }

    [BlubMember(1)] public Guid Version { get; set; }
  ...
  internal class RequestStartServerHolepunchMessage : ICoreMessage
  {
    ...
    [BlubMember(0)] public Guid MagicNumber { get; set; }
  }
  ...
  internal class PeerUdp_ServerHolepunchAckMessage : ICoreMessage
  {
    ...
    [BlubMember(2)] public uint HostId { get; set; }
  }
  ...
  internal class UnreliablePongMessage : ICoreMessage
  {
    ...
    [BlubMember(0)] public double ClientTime { get; set; }

    [BlubMember(1)] public double ServerTime { get; set; }
  }
  ...
  internal class ReliableRelay2Message : ICoreMessage
  {
    ...
    [BlubMember(0)] public RelayDestinationDto Destination { get; set; }
