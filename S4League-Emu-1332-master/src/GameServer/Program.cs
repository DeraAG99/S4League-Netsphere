  ...
  internal class Program
  {
    ...
    private static void Main()
    {
      ...
      Log.Logger = new LoggerConfiguration()
          ...
          .CreateLogger();
      var Logger = Log.ForContext(Constants.SourceContextPropertyName, "Initializor:");
      Logger.Information("============================================");
            Logger.Information("Initializing GameServer build");
         // $"{GlobalVersion.Major}.{GlobalVersion.Major / 2 + GlobalVersion.Minor + GlobalVersion.Build + GlobalVersion.Revision}");
#if NEWIDS
            Logger.Information("New IDS");
#endif
#if LATESTS4
            Logger.Information("Latest S4");
#endif
      Logger.Information("============================================");
      ...
      GameDatabase.Initialize();
            ...
            Logger.Information("____________________________________________");
            Logger.Information("____________________________________________");
            Logger.Information("============================================");
      ...
      if (Config.Instance.ACMode == 2)
        Logger.Information("[BattleEye] Activated");
      ...
      Logger.Information("____________________________________________________________");
