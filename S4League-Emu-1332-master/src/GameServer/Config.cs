...
namespace NeoNetsphere
{
  public class Config
  {
    ...
    [JsonProperty("game_webapi")] public FumbiAPI FumbiAPI { get; set; }
    ...
    [JsonProperty("ac_mode")] public int ACMode { get; set; }

    [JsonProperty("res_check")] public bool ResCheck { get; set; }

    [JsonProperty("res_check_hash")] public string ResHash { get; set; }
  ...
  public class FumbiAPI
  {
    ...
    public FumbiAPI()
    {
      EndPoint = new IPEndPoint(IPAddress.Loopback, 45000);
      UpdateInterval = TimeSpan.FromSeconds(25);
    }
  }
